...
public:
	...
	void storedata(){
		ofstream fout;
		fout.open("result1.txt",ios::app);
		
		fout.write((char*)this,sizeof(*this));
		fout.close();}
		void viewdata(){
			ifstream fin;
			fin.open("result1.txt",ios::app);
			if(!fin)
			cout<<"\nfile not found"<<endl;
			else{
...
if(random==gussing_number&&color==random_color)
	...
	cout<<"You won by both COLOR and NUMBER"<<endl;
		cout<<"Your gussing number was"<<gussing_number<<endl;
			winned_amount= winningamount-bidding_amount1;
		cout<<"You have won=$"<<winned_amount<<endl;}
	else
	...
	cout<<"The color was="<<random_color<<endl;
		cout<<"Your gussing number was="<<gussing_number<<endl;
		cout<<"You loose=$"<<bidding_amount1<<endl;}
